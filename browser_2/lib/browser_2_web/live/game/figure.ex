    ...
    <div class="figure">
      <svg id="drawing"
        ...
        <g transform="translate(-27.2 -220)">
          ...
          <!-- 1 -->
          <path id="rope"
                class={should_hide(@turns_left, 6)}
          ...
          <!-- 6 -->
          <path id="arm1"
                class={should_hide(@turns_left, 0)}
          ...
          <!-- 7 -->
          <path id="arm2"
                class={should_hide(@turns_left, 1)}
                style="fill: #777; stroke: #777; stroke-width: 3.5;"
          ...
          <!-- 8 -->
          <path id="leg1"
                class={should_hide(@turns_left, 2)}
                style="fill: #777; stroke: #777; stroke-width: 3.5;"
          ...
          <!-- 9 -->
          <path id="leg2"
                class={should_hide(@turns_left, 3)}
                style="fill: #777; stroke: #777; stroke-width: 3.5;"
          ...
          <!-- 10 -->
          <path id="body"
                class={should_hide(@turns_left, 4)}
                style="fill: #777; stroke: #777; stroke-width: 3.5;"
          ...
          <!-- 11 -->
          <path id="head"
                class={should_hide(@turns_left, 5)}
